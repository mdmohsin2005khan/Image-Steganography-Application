...
import stegano.image.processing.Stegno;
...
public class SwingEmailSender  extends JFrame {    
    ...
    public SwingEmailSender() {        
        super("Swing E-mail Sender Program");                  // set up layout
    ...
    public static void main(String[] args) {         // set look and feel to system dependent
